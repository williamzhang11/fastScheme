...
import com.xiu.sparkproject.domain.SessionRandomExtract;
 ...
 *
 */
public class UserVisitSessionAnalyzeSpark3top10 {
	...
	private static void randomExtractSession(final long taskid,
		...
		//计算出每天每小时的session数量，获取<yyyy-MM-dd_HH ,session_id>格式id
		...
		Map<String, Map<String,Object>> dayHourCountMap = new HashMap<String, Map<String,Object>>();
	...
	private static void getTop10Category(
		...
		//点击，下单，支付，然后通过map,reduceByKey等算子进行计算
		//计算各品类点击次数
